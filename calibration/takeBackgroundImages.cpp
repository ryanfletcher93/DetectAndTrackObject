...
#define FILE1_TEMPLATE "cameraSetup2/cam1/backgroundImageWithObjects1*.png"
#define FILE2_TEMPLATE "cameraSetup2/cam2/backgroundImageWithObjects1*.png"
#define REPLACE_STR "\\*"
